...
1. Collect context
   ...
   d. Record any "Worktrees" note in the plan; if absent, run `git worktree list` and identify entries whose branch name or path contains the issue key. Ask the user for clarification if multiple branches are ambiguous.
